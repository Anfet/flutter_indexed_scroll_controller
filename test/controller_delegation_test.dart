...
void main() {
  group('IndexedScrollController delegation tests (pre-extends)', () {
    group('onAttach/onDetach callbacks', () {
      testWidgets('onAttach is called when controller attaches to ScrollPosition',
      ...
      testWidgets('onDetach is called when controller detaches from ScrollPosition',
          (WidgetTester tester) async {
    ...
    group('listener management with measurement operations', () {
      testWidgets('listeners receive updates during scrollTo operations',
        ...
        // Perform a scrollTo
        unawaited(
          state.controller.scrollTo(10.0,
